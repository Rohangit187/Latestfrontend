    ...
    <>
      ...
      <div className="px-5  py-5  text-left bg-gray-50 rounded-lg">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700">
            Stay updated with the latest news from various industries. Our portal brings all trending and breaking news into one platform, ensuring users stay informed anytime, anywhere.
          </p>
        </div>
        */}
...
export default ForBusinessPageUsp;
